...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="csrf-token" content="{{ csrf_token() }}">
                <meta name="description" content="HasbiStore - Welcome to Your Premium Shopping Destination">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100">
            ...
            <div class="mt-8 text-center text-gray-600 text-sm">
                                <p class="text-sm text-gray-500">© {{ date('Y') }} HasbiStore. All rights reserved.</p>
